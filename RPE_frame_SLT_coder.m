function [Nc,bc,CurrFrmExFull,CurrFrmSTResd] = RPE_frame_SLT_coder(s0, PrevFrmSTResd)
...
prevd = [PrevFrmSTResd(80:160)' s0(1:80)'];
...
prevd = [PrevFrmSTResd(120:160)' s0(1:120)'];
...
[N,b] = RPE_subframe_LTE(s0(121:160), s0(1:120));
Nc(4)=N;
if (b<=DLB(1))
    bc(4)=0;
elseif (DLB(1)<b && b<=DLB(2))
